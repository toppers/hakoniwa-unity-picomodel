...
namespace Hakoniwa.PluggableAsset.Assets.Robot.Pico
{
    public class PicoLightSensor : MonoBehaviour, IRobotPartsSensor, IRobotPartsConfig
    {
        ...
        public void Initialize(object root)
        {
            ...
            this.pdu_writer = this.pdu_io.GetWriter(this.root_name + "_light_sensorPdu");
            if (this.pdu_writer == null)
            {
                throw new ArgumentException("can not found pico_sensor pdu:" + this.root_name + "_light_sensorPdu");
            }
